...
const firebaseConfig = {
    apiKey: "AIzaSyBpxneBV1JQQdyvhPqtt6OG_jl0WbyAMUU", // Firebase Console'dan alın
    authDomain: "tatilkaptanifinal.firebaseapp.com", // Firebase Console'dan alın
    projectId: "tatilkaptanifinal", // Firebase Console'dan alın
    storageBucket: "tatilkaptanifinal.firebasestorage.app", // Firebase Console'dan alın
    messagingSenderId: "748801975441", // Firebase Console'dan alın
    appId: "1:748801975441:web:cc26b7b825fafe44658b30", // Firebase Console'dan alın (Sonunda virgül olmalı!)
    measurementId: "G-0BQJQ25XX1", // Firebase Console'dan alın (Sonunda virgül olmalı!)
};
...
window.showModal = function(title, message) {
    ...
    return new Promise((resolve) => {
        const handleConfirm = () => {
            ...
            modalConfirmBtnBtn._eventListener = null;
            resolve(true);
        };
